...
<a id="deepseek-aidsh-bun-local"></a>
...
来源：[`packages/bun/bun-local/src/index.ts:30`](../packages/bun/bun-local/src/index.ts)
...
需要：`tools` · `bun` · `systemPrompt` · `shellEnv`
...
来源：[`packages/bun/tool-bun/src/index.ts:32`](../packages/bun/tool-bun/src/index.ts)
...
- `@deepseek-ai/dsh-bun` — 抽象 `BunExecutor`（[`packages/bun/bun/src/index.ts`](../packages/bun/bun/src/index.ts)）
