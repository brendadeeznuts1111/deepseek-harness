...
| `ctx.weather` | `seam` | [`tutorial-tools`](../packages/examples/tutorial-tools) | [`tutorial-tools`](../packages/examples/tutorial-tools) | [`tutorial-tools`](../packages/examples/tutorial-tools) | - | The tutorial capability seam: local and live-web providers register as ctx.weather; the greet and weather tools consume it. |
