...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bun/bun': { kind: 'indirect', reason: 'The service interface delegates all model rendering to dsh-tool-bun.' },
  'packages/bun/bun-local': { kind: 'indirect', reason: 'The executor backend delegates model rendering to dsh-tool-bun.' },
