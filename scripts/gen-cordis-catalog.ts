...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  WeatherRequest: 'weather lookup request contract is owned by packages/examples/tutorial-tools/README.md',
  WeatherResult: 'weather lookup result contract is owned by packages/examples/tutorial-tools/README.md',
