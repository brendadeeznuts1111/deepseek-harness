...
- **The starter MIME table is minimal** — it covers the Vite-emitted asset set, the shipped PWA manifest, and PNG app icons; other extensions fall back to `application/octet-stream` until an asset class actually ships.
